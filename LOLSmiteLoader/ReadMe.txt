========================================================================
    KONSOLENANWENDUNG: LOLSmiteLoader-Projektübersicht
========================================================================

Diese LOLSmiteLoader-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre LOLSmiteLoader-Anwendung besteht.


LOLSmiteLoader.vcxproj
...
LOLSmiteLoader.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen LOLSmiteLoader.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
